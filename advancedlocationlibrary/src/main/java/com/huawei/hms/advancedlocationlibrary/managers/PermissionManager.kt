...
import com.huawei.hms.advancedlocationlibrary.utils.AdvancedLocationException.Companion.MISSING_PERMISSION
import com.hms.lib.livelocation.utils.device.DeviceUtils.isAboveM
import com.hms.lib.livelocation.utils.device.DeviceUtils.isAboveQ
...
internal class PermissionManager(private val context: Context) {
    ...
    companion object {
        ...
        private val ACTIVITY_PERMISSION = arrayOf("com.huawei.hms.permission.ACTIVITY_RECOGNITION")
